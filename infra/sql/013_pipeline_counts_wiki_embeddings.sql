-- Add embeddings_wiki_computed: count of embeddings based on Wikipedia bio text.
-- Embeddings from fetch-bio have source LIKE '%fetch_bio%' (e.g. fetch_bio:en).
-- DROP required because column order changes.
